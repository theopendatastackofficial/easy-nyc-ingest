...
nyc_nypd_arrests_ytd_rename_map: Dict[str, str] = {}

nyc_nypd_arrests_ytd_schema_cfg: Dict[str, Any] = dict(
    rename_map = nyc_nypd_arrests_ytd_rename_map,
...
nyc_nypd_arrests_ytd_raw, nyc_nypd_arrests_ytd = build_single_socrata_asset(
    asset_name = "nyc_nypd_arrests_ytd",
    endpoint   = "https://data.cityofnewyork.us/resource/uip8-fykc.json",
    schema_cfg = nyc_nypd_arrests_ytd_schema_cfg,
